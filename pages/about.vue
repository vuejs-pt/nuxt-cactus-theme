...
useSEO({
	title: "About",
	description: "I'm a starter theme for Nuxt",
});
</script>
...
<template>
	<section>
		...
		<div class="prose prose-sm prose-cactus max-w-none">
			<p>
				Hi, I'm a starter Nuxt theme. I'm particularly great for getting you started with your own
				blogging website.
			</p>
			...
			<p>
				...
				<a
					...
					href="https://github.com/vuejs-pt/nuxt-cactus-theme"
					rel="noreferrer"
					target="_blank"
				>
					repo
