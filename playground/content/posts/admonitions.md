...
description: "This post showcases using the markdown admonition feature in Nuxt Cactus"
...
To use admonitions in Nuxt Cactus, wrap your Markdown content in a pair of triple colons `:::`. The first pair should also include the type of admonition you want to use.
...
::github{repo="ruiposse/nuxt-theme-cactus"}
::

You can also link a Github user:

::github{user="ruiposse"}
::
